...
public class tvPersonaTipoDTO {
    ...
    public tvPersonaTipoDTO() {

    }
    public tvPersonaTipoDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion, String estado,
